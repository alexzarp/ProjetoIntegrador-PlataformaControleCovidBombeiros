<div>
    <form  method="POST" onsubmit="return validateForm()">
        ...
        <input type="text" onkeypress="return SomenteNumero(event);" ondrop="return false;" onpaste="return false;" 
        id="error" maxlenght="7" 
        name="matricula" placeholder="Matrícula no formato 1234567"><br>
